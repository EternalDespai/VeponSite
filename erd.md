...
Vepon VPN использует единую базу данных **clients.db**, которая хранит информацию о пользователях, VPN-устройствах, магазине, заказах, платежах и служебных данных.
